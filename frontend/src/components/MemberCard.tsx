...
const statusClasses: Record<CardStatus, string> = {
	avail:
		"relative flex min-h-full flex-col items-center overflow-hidden rounded-[1.15rem] border border-white/12 border-b-[5px] border-b-emerald-500 bg-[linear-gradient(180deg,rgba(15,23,42,0.86),rgba(15,23,42,0.68))] px-3 py-4 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-transform duration-200 sm:px-4 sm:py-5 lg:px-3.5 lg:py-4 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_18px_36px_rgba(0,0,0,0.28)]",
	warn:
		"relative flex min-h-full flex-col items-center overflow-hidden rounded-[1.15rem] border border-white/12 border-b-[5px] border-b-amber-400 bg-[linear-gradient(180deg,rgba(15,23,42,0.9),rgba(15,23,42,0.72))] px-3 py-4 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-transform duration-200 animate-[card-glow_2s_ease-in-out_infinite] sm:px-4 sm:py-5 lg:px-3.5 lg:py-4 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_18px_36px_rgba(0,0,0,0.28)]",
	sold:
		"relative flex min-h-full flex-col items-center overflow-hidden rounded-[1.15rem] border border-white/12 border-b-[5px] border-b-rose-500 bg-[linear-gradient(180deg,rgba(15,23,42,0.8),rgba(15,23,42,0.62))] px-3 py-4 text-center opacity-90 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-transform duration-200 sm:px-4 sm:py-5 lg:px-3.5 lg:py-4 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_18px_36px_rgba(0,0,0,0.28)]",
	closed:
		"relative flex min-h-full flex-col items-center overflow-hidden rounded-[1.15rem] border border-white/12 border-b-[5px] border-b-slate-500 bg-[linear-gradient(180deg,rgba(51,65,85,0.34),rgba(30,41,59,0.22))] px-3 py-4 text-center opacity-85 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-transform duration-200 sm:px-4 sm:py-5 lg:px-3.5 lg:py-4 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_18px_36px_rgba(0,0,0,0.28)]",
};
