/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 368cdefd964fbbe95e38f337ea63aeee)
// Runtime types generated with workerd@1.20260706.1 2026-07-08 nodejs_compat
interface __BaseEnv_Env {
	JKT48_CACHE: KVNamespace;
	UPSTREAM_COORDINATOR: DurableObjectNamespace<import("./src/index").UpstreamCoordinator>;
	WAITING_ROOM_COORDINATOR: DurableObjectNamespace<import("./src/index").WaitingRoomCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UpstreamCoordinator" | "WaitingRoomCoordinator";
	}
